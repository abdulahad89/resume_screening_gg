...
MAIN_MODEL = GOOGLE_AI_MODELS["flash_20_lite"]            # Main model for all tasks
SCORING_MODEL = GOOGLE_AI_MODELS["flash_20_lite"]         # For relevance scoring
CHATBOT_MODEL = GOOGLE_AI_MODELS["flash_20_lite"]         # For chatbot
DATA_EXTRACTION_MODEL = GOOGLE_AI_MODELS["flash_20_lite"] # For data extraction
